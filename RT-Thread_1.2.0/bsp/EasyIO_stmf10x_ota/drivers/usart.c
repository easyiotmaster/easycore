...
//		}
		...
		//因为这个模块，被设置为了奇偶校验，所以暂时设git 置为这个模式
		//if (uart->uart_device == USART3)
		//{
...
void __disable_isp_serial(void)
{
	/* Enable USART */
...
void __config_to_stm32_isp_serial_mod(void)
{
...
void __config_to_default_serial_mod(void)
{
	USART_InitTypeDef USART_InitStructure;
