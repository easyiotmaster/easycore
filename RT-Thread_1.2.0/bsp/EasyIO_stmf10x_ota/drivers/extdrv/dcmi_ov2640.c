...
void OV2640_CaptureGpioInit(void)
{
	...
	GPIOC->ODR |= 0x00FF;
	Exit_Init(GPIOB, GPIO_Pin_8, GPIO_Mode_IPU, EXTI_Trigger_Rising_Falling, 0, 0);	//VSYNC
	Exit_Init(GPIOB, GPIO_Pin_15, GPIO_Mode_IPU, EXTI_Trigger_Falling, 0, 0);//PICLK
...
void EXTI15_10_IRQHandler(void)
{
	//if(EXTI_GetITStatus(EXTI_Line15) != RESET)	  	//检查指定的EXTI0线路触发请求发生与否
	{
		...
		if (JpegDataCnt >= JPEG_BUFFER_LENGTH)
			return ;
